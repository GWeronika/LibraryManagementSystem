...
(2, 'Inne Wydawnictwo', '9782345678901', 2021, 'BOOK', 'Angielski', '"1984" is a dystopian masterpiece that explores a nightmarish future where a totalitarian regime, led by the enigmatic Big Brother, controls every aspect of its citizens'' lives. Through the eyes of protagonist Winston Smith, the novel delves into the chilling consequences of thought control, surveillance, and the manipulation of truth in a society stripped of individuality and freedom.', 'AVAILABLE', 1, 2),
(3, 'Wydawnictwo ABC', '9783456789436', 2020, 'BOOK', 'Polski', '"Erystyka" to niezwykłe dzieło, w którym autor odkrywa sztukę argumentacji i sztuczki używane w dyskusjach. Z głębokim zrozumieniem ludzkiej psychologii Schopenhauer ukazuje, jak manipulować retoryką i jakie pułapki czyhają na niewprawionego dyskutanta. To praktyczne kompendium dla tych, którzy chcą zrozumieć tajniki perswazji i obronić się przed erystycznymi chwytami w dialogu.', 'UNAVAILABLE', 2, 3),
...
(21, 'Wydawnictwo XYZ', '9781234567890', 2022, 'BOOK', 'Polski', '"Opowieści z Narnii" to magiczna seria siedmiu książek C.S. Lewisa, zabierająca czytelników w niezwykłe podróże do krainy Narnii. Pełne przygód i mądrych przesłań, opowieści te ukazują wieczną walkę dobra ze złem, a także rozwijające się relacje między bohaterami.', 'AVAILABLE', 1, 10),
